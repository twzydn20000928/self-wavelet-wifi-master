...
if __name__ == '__main__':
    ...
    model_list = [
        ('resnet2d_101_2', 'resnet2d_span_cls_raw', 128),
        ('resnet2d_101_2', 'resnet2d_span_cls_freq', 128),

        ('resnet2d_50_2', 'resnet2d_span_cls_raw', 128),
        ('resnet2d_50_2', 'resnet2d_span_cls_freq', 128),

        ('resnet2d_34_2', 'resnet2d_span_cls_raw', 128),
        ('resnet2d_34_2', 'resnet2d_span_cls_freq', 128),
